...
const SideBar = ({ activeItem, setActiveItem }) => {
  ...
  return (
    <>
      <aside className="sidebar-container relative bg-sidebar h-screen sm:block" data-aos="fade-right">
        <div className=" logo-container">
          ...
          >
            <img className="nav-logo" src={togatherLogo} alt="Logo" />
          </a>
        </div>
        <nav>
          <a
          ...
          <a
            ...
            className={`nav-item ${activeItem === "vendors" ? "active" : ""
              }`}
          >
            <svg
              width="18"
          ...
          <a
            ...
            className={`nav-item ${activeItem === "budget" ? "active" : ""
              }`}
          >
            <svg
              width="18"
          ...
          <a
            ...
            className={`nav-item ${activeItem === "guests" ? "active" : ""
              }`}
          >
            <svg
              width="18"
          ...
          <a
            ...
            className={`nav-item ${activeItem === "collaborators" ? "active" : ""
              }`}
          >
            <svg
              width="18"
