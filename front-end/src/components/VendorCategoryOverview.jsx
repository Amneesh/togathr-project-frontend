        ...
        <div className='main-cat'>
            ...
            <div className='flex-cat'>
                ...
                <div className='m-cat'>
                    <div className='bg-color' >
                        ...
                        <svg width="34" height="34" viewBox="0 0 34 34" fill="#5E11C9" xmlns="http://www.w3.org/2000/svg">
                            <path d="M9.74074 19.9674H6.62963L3 32.0002H31L27.3704 19.9674H23.7407L16.9962 28.1475C16.8497 28.3251 16.5774 28.3246 16.4316 28.1464L9.74074 19.9674Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                            <path d="M23.8774 15.4896L16.7132 24.0373L9.64185 15.4588C9.06452 14.7584 8.55543 13.9924 8.27827 13.1281C7.48835 10.6648 7.82223 8.72536 8.30657 7.60572C8.51985 7.11271 8.81552 6.65585 9.09814 6.19905C12.3331 0.970343 18.3159 1.62447 20.8309 2.88582C26.021 5.48883 26.0443 10.3361 25.192 13.2375C24.9442 14.081 24.4421 14.8158 23.8774 15.4896Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                            <path d="M20.044 10.0678C20.044 11.7686 18.6029 13.2361 16.7139 13.2361C14.8249 13.2361 13.3839 11.7686 13.3839 10.0678C13.3839 8.36704 14.8249 6.8995 16.7139 6.8995C18.6029 6.8995 20.044 8.36704 20.044 10.0678Z" stroke="white" strokeWidth="3.11931" />
                        </svg>
                        </button>
                    </div>
                ...
                <div className='m-cat'>
                    ...
                    <button onClick={(e) => active('vendors')}>
                        <svg width="34" height="34" viewBox="0 0 34 34" fill="#5E11C9" xmlns="http://www.w3.org/2000/svg">
                            <path d="M17.1304 31.9934C17.2997 28.2251 19.9629 20.5998 29.2606 20.2441C28.9537 24.2558 26.0979 32.222 17.1304 31.9934Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                            <path d="M17.1304 31.9934C16.961 28.2251 14.2979 20.5998 5.0001 20.2441C5.30706 24.2558 8.16286 32.222 17.1304 31.9934Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                            <path d="M13.796 17.4609C13.7643 18.6041 14.3994 20.9158 17.1938 21.0175C19.9882 21.1191 20.6021 18.6888 20.5598 17.4609" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                            <path d="M20.5611 17.4365C21.5453 18.0189 23.8748 18.5852 25.3195 16.191C26.7641 13.7969 24.9369 12.0809 23.8427 11.5222" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                            <path d="M23.9711 11.5225C24.9556 10.9407 26.5743 9.17227 25.1725 6.75278C23.7707 4.3333 21.3866 5.10761 20.3698 5.7972" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                            <path d="M20.431 5.8398C20.5105 4.69896 19.9727 2.36269 17.185 2.14431C14.3972 1.92594 13.6822 4.32843 13.6732 5.55697" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                            <path d="M13.7314 5.66503C12.7541 5.07107 10.4314 4.47741 8.95866 6.8544C7.48592 9.23139 9.2928 10.9687 10.3803 11.5403" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                            <path d="M10.3311 11.5224C9.33704 12.0878 7.6892 13.8291 9.05061 16.2715C10.412 18.714 12.8086 17.9794 13.8367 17.3068" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                            <circle cx="17.0984" cy="11.553" r="2.58424" stroke="white" strokeWidth="1.5" />
                        </svg>
                        </button>
                    </div>
                    <p>florist</p>
